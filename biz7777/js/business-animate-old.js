    ...
    function scrollToCenter() {
      if(!isInWindow) { 
        ...
        setTimeout(()=>{
          ...
          // console.log('scrollingElem.offsetWidth - scrollingElemWIdth: ', scrollingElem.offsetWidth - scrollingElemWIdth);
          // console.log('elTranslateX == scrollingElem.offsetWidth - scrollingElemWIdth: ', elTranslateX == scrollingElem.offsetWidth - scrollingElemWIdth);
      ...
      if(isInWindow && isLocked) {
        ...
        // ) {
          ...
          function scrollBlock() {
            ...
            // if(elTranslateX == scrollingElem.offsetWidth - scrollingElemWIdth && e.deltaY > 0) {
